...
export default function Work() {
  ...
  // ✅ reset read more ตอนเปลี่ยน project
  useEffect(() => {
    setExpanded(false)
  }, [current])
    ...
    <section id="work" className="py-24 px-6">
      <div className="max-w-5xl mx-auto" ref={ref}>
        ...
        >
          ...
          <button
            onClick={prev}
            className="flex-shrink-0 w-10 h-10 border-[3px] border-black bg-[#e9e7e1] shadow-brutal-sm flex items-center justify-center"
          >
            ◁
          </button>
          ...
          >
            ...
            >
              ...
              <div className="absolute top-3 left-3 text-xs border bg-white px-2">
            ...
            <div className="bg-[#2d2d2d] text-white p-6">
              ...
              <motion.p
                layout
                className={`font-mono text-xs text-white/60 mb-2 leading-relaxed ${
              ...
              <button
                ...
                className="text-[10px] text-white/40 hover:text-white transition mb-4"
              >
              ...
              <div className="flex gap-2 flex-wrap mb-4">
                {project.tech.map((t) => (
                  <span
                    key={t}
                    className="text-xs border px-2 py-0.5 text-white/80"
                  >
                    {t}
                  </span>
                ))}
              ...
              <div className="border-t border-white/20 pt-3 flex gap-4">
                <a href={project.live} target="_blank" className="text-xs flex items-center gap-1">
                  <FontAwesomeIcon icon={faArrowUpRightFromSquare} />
                  live
                </a>
                <a href={project.source} target="_blank" className="text-xs flex items-center gap-1">
